...
All the environments are registered in the `IGRIS_C_walk` extension. They start
...
import IGRIS_C_walk.tasks  # noqa: F401


def main():
    """Print all environments registered in `IGRIS_C_walk` extension."""
